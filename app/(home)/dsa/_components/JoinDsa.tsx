...
const JoinDsa = () => {
  return (
    <article
      className=" w-full min-h-[50vh] bg-no-repeat bg-center object-contain bg-dsaPrimary  items-center flex flex-col justify-center space-y-6 text-xl font-semibold "
