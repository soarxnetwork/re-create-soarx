      ...
      <div className="lg:grid lg:grid-cols-3 myfonts space-y-12 pl-7 md:pl-20 md:pr-28 sm:pl-16 sm:pr-16 pr-7">
        <div className="break-words  2xl:ml-7 lg:mr-40 space-y-6 col-span-2">
          <div className="flex flex-col gap-y-3">
            <p className="text-lg dark:text-white border-black border-2 w-fit pl-2 pr-2 border-opacity-5 text-red-800 font-medium rounded-sm">
              LIVE
            </p>
          </div>
          <div className="space-y-4">
            <h3 className="text-[25px] lg:text-4xl leading-normal lg:leading-loose sm:leading-normal sm:text-3xl dark:text-white text-black font-semibold 2xl:text-5xl">
              {"2.5 Month Salesforce Training Program".split("").map((child, idx) => (
                <span className={"hoverText leading-normal"} key={idx}>
                  {child}
                </span>
              ))}
            </h3>
