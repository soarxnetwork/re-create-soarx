  ...
  return (
    <>
      ...
      <div className="2xl:mr-40 space-y-4 lg:ml-24 sm:ml-6 sm:mr-3 lg:mr-5">
        ...
        This course includes comprehensive lectures and hands-on exercises to enhance your understanding of <span className="font-bold">Salesforce, a powerful CRM platform</span>, preparing you to tackle technical interviews with confidence.
        </p>
      </div>
