...
const PrevLectures = () => {
    return (
      <div className="max-w-screen-xl p-8 mb-32 mt-10">
        <h2 className="text-5xl font-semibold mb-20 pr-5 flex justify-end">Have a look at our previous live lectures</h2>
        <div className="prev-lectures w-full">
          <div className="lecture-wrapper w-full flex justify-end gap-x-4">
