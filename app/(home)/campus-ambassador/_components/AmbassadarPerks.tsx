  ...
  return (
    <div className="flex w-full myfonts gap-y-8 flex-col items-center mt-10 mb-10 lg:pl-3 xl:pl-0 2xl:pl-9 2xl:pr-28">
      <div className="flex flex-col gap-y-6 items-center">
        <div className="text-3xl md:text-4xl font-semibold">Whats in it for you</div>
        <div className="text-[#8919E4] md:text-2xl font-medium pl-16 lg:pl-0 cursor-pointer">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 ml-3 md:ml-8 xl:ml-0 md:mr-4 mr-3 xl:mr-10 dark:text-white  gap-x-5 gap-y-7">
